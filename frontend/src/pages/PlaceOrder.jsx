          ...
          <div className='flex gap-3 flex-col lg:flex-row '>
            ...
            <div onClick={()=>setmethod('stripe')}className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              ...
              <img className='h-5 mx-4' src={assets.stripe_logo}/>
                        ...
                        <div onClick={()=>setmethod('razarpay')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3.5 border rounded-full  ${method === 'razarpay' ? 'bg-green-400':''}`}></p>
